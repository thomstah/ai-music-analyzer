'use client';
import { DeezerAlbum } from '@/types/song';

export default function DeezerAlbumBanner({ album }: { album: DeezerAlbum }) {
      ...
      <div className="relative z-10 flex gap-6 p-6 items-end">
        ...
        <div className="min-w-0">
          ...
          <div className="flex flex-wrap gap-x-6 gap-y-1 mt-3 text-xs text-neutral-400">
            ...
            <span className="text-neutral-500">Powered by Deezer</span>
          </div>
        </div>
      </div>
    </div>
